...
exports.generateS3UploadUrl = void 0;
...
exports.generateS3UploadUrl = (0, https_1.onCall)({ region: "asia-south1", cors: true }, async (request) => {
    const fileType = request.data.fileType;
    logger.info("Generating S3 URL for type:", fileType);
    ...
    const fileKey = `avatars/${(0, uuid_1.v4)()}`;
...
//# sourceMappingURL=generateS3UploadUrl.js.map